...
def generatePairs(input_dir, same_pair_num, diff_pair_num):
    ...
    for diff_comb in diff_combs:
        ...
        # make sure one of the pair has a '1' whick indicates there is a IDCard image
        if ((person_01_id == '1' and person_02_id != '1') or (person_01_id != '1' and person_02_id == '1')):
            ...
            continue
    if (len(diff_lines) > diff_pair_num):
        diff_lines = random.sample(diff_lines, diff_pair_num)
